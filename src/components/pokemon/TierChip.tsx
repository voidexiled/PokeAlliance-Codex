...
// delegated controller of 7.5.4 opens on hover and focus; only the pill while the tooltip has
// nothing to add (no «Max brokes» yet). Nothing for an unknown or hidden tier: the caller
// writes «—». A server component with no JavaScript of its own.
